...
file.copy("print_ver/gwl.pdf", "print_ver/envreportbc_gwl_January2019.pdf") #delete existing file, does not overwrite
tools::compactPDF("print_ver/envreportbc_gwl_January2019.pdf", gs_quality = "ebook")
