...
- **Stable**: the slope was _not_ significantly different from zero **or** the slope was significantly different from zero with an increasing or decreasing trend of less than 3 cm per year.
- **Increasing**: the slope was significantly different from zero with an increasing trend of 3 or greater cm per year.
- **Moderate Rate of Decline**: the slope was significantly different from zero with a declining trend of between three and ten cm per year.
- **Large Rate of Decline**: the slope was significantly different from zero with a declining trend of more than ten cm per year.

\begin{center}
\fbox{
  \begin{minipage}[c]{12cm}
  
   \begingroup\centering{\textbf{Trend Categories}}
...
align(x.table) <- c('l', rep('l', 4), 'p{0.6in}', rep('l', 1))
...
The trend category, slope and significance of the trend are given below the title. Dark grey
