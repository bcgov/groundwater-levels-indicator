...
colour.scale <- c("#BCDEFF", "#DCDDDD", "#FFC300", "#FE8C02", "#FFFFFF")
...
\definecolor{increasing}{HTML}{`r substr(colour.scale[1], 2, 7)`}
\definecolor{stable}{HTML}{`r substr(colour.scale[2], 2, 7)`}
\definecolor{moderate}{HTML}{`r substr(colour.scale[3], 2, 7)`}
\definecolor{large}{HTML}{`r substr(colour.scale[4], 2, 7)`}
\definecolor{missing}{HTML}{`r substr(colour.scale[5], 2, 7)`}
