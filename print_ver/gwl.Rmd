...
x.table <- xtable(out.table, digits = c(0,0,0,2,3,0,0))
...
Based on the
magnitude and significance of the calculated trend, water levels in wells were classified as exhibiting the following trend categories:

- **Stable**: the slope was not significantly different from zero
- **Increasing**: the slope was significant and increasing at greater than 3
cm per year.
- **Moderate Rate of Decline**: the slope was significant and declining at a rate between
three and ten cm per year.
- **Large Rate of Decline**: the slope was
