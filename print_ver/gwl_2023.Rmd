...
municipalities, farms, and rural homeowners in British Columbia. B.C. operates a provincial [observation well network of over 200 wells](https://www2.gov.bc.ca/gov/content?id=B03D0994BB5C4F98B6F7D4FD8610C836), which was established in 1961 to monitor groundwater availability in areas of high human use.
...
in groundwater levels recorded at `r nrow(attr_wells)` observation wells that have been monitored for ten years or more and that were active as of 2013.
...
- The number of wells in each Natural Resource Regions across B.C. varies. The highest number of observation wells is in the West Coast Region, with 62 wells. The location and status can be seen in the map below

\vspace{-20pt}
\hspace{-20pt}

```{r overview_map, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, fig.align = 'left', fig.width = 16, fig.asp=0.75}
# summary map
# print(leaflet_map)
