...
Up to 1 million British Columbians are estimated to consume groundwater. Hundreds of groundwater aquifers provide water for industries, municipalities, farms, and rural homeowners. British Columbia  operates a provincial [observation well network of over 200 wells](https://www2.gov.bc.ca/gov/content?id=B03D0994BB5C4F98B6F7D4FD8610C836). This network was established in 1961 to track groundwater availability in areas of high human use.
...
The location and status for each observation well can be seen in the map below. Small (grey colour) symbols represent locations with insufficient data to estimate a trend. Opaque symbols represent stations with a signficant trend (colour represents direction and magnitude), while semi-transparent symbols represent locations with non-signficant results. 
