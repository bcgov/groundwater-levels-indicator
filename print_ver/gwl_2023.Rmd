...
weather and climate patterns^1^. [Aquifers](https://www2.gov.bc.ca/gov/content/environment/air-land-water/water/groundwater-wells-aquifers/understanding-aquifers) are geological formations of permeable rock, gravel, or sand containing or conducting groundwater.
...
```{r overview_map, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, fig.align = 'left', fig.width = 24, fig.asp=0.75}
# summary map
# print(leaflet_map)
