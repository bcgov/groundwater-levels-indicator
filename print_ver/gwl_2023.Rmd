...
-   The number of observation wells in each [Natural Resource
    ...
    varies. The highest number of observation wells in the West Coast Region. The
    lowest number of observation wells is the Skeena and Omineca regions.
...
```{r well_plots, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, results = 'asis', fig.height = 8, dev = "pdf"}
